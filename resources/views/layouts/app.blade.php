                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @if (Auth::user()->imaUlogu('doktor'))
                            <li class="nav-item">
                                <a class="nav-link" href="http://127.0.0.1:8000/pregled-prijava">Pregled prijava</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://127.0.0.1:8000/statistika">Statistika prijavljenih</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://127.0.0.1:8000/doktor/obaveze">Moje obaveze</a>
                            </li>
                        @endif
